...
const profileFr = {
  ...
  alias: 'Élève ingénieur télécom · Fullstack & Lead Developer · UX/UI · IA',
  title: 'Élève ingénieur télécom · Fullstack & Lead Developer · Frontend & UX/UI · AI Engineer',
  fullTitle: 'Élève ingénieur télécom · Fullstack · Frontend & UX/UI · IA',
  ...
  currentFocus: [
    ...
    'Formation Hugging Face LLM Course',
    'AMD AI Academy Challenge — LLMs, RAG, agents',
    'Claude Cameroun — communauté née début 2026',
    'Président du club info SUP\'PTIC (élu 2026)',
  ],
  stats: [
    { label: 'Projets choisis', value: '9', project: 'CV · GitHub · compétitions', image: '/illustrations/projects-grid.webp' },
    { label: 'Année de formation', value: '3e', project: "SUP'PTIC · Informatique & Réseaux" },
    { label: 'Échecs', value: '1600', project: 'Elo · plus football, scrabble, jeux', icon: '/photos/chess.webp' },
